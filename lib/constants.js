export const coincept_address = "0xd3D0c7c2b53d91581B0F9fd7A12b45928De9aA8A";
export const coincept_abi = [
  {
    inputs: [
      { internalType: "address", name: "clanker_", type: "address" },
  ...
  { inputs: [], name: "WinnerAlreadyPicked", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
    ...
    outputs: [
      {
        ...
        internalType: "struct ICoincept.Build[]",
        name: "",
        type: "tuple[]",
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: "struct ICoincept.BuildInfo[]",
        name: "",
        type: "tuple[]",
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: "struct ICoincept.Contest",
        name: "",
        type: "tuple",
      },
    ],
